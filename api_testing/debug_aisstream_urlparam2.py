#!/usr/bin/env python3
"""
Debug script for AISStream WebSocket connection - testing API key in URL parameter (api_key).
"""
...
async def test_api_key_in_url():
    ...
    print("=" * 60)
    print("Testing AISStream WebSocket - API Key in URL (api_key)")
    print("=" * 60)
    print()
    
    print("WebSocket URL: wss://stream.aisstream.io/v0/stream?api_key=<redacted>")
    print()
